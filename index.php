...
<html lang="en">
<head>
	<title>HIGH - SaaS Installer</title>
	<meta charset="UTF-8">
        ...
        <div class="row mt-4">
            ...
            <div class="card">
                ...
                <div class="empty-state p-2">
                    ...
                    <h2>Welcome to HIGH SaaS Installer | <?php echo strrev ('>a/< /oc.stpircsmo//:sptth yB>"knalb_"=tegrat "/oc.stpircsmo//:sptth"=ferh ";tnatropmi! der :roloc"=elyts a<'); ?></h2>
                </div>
